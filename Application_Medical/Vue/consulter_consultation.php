<?php
   ...
   require('../Controller/consulter_consultation_2bdd.php');
               ...
               <div id="content" class="span9">
                    <div class="main_body">
                         ...
                         <div class="Left-body">
                              ...
                              <div class="en_bref">
                                   <form action="../Controller/consulter_consultation_2bdd.php" method="get">
                                        <table>
                                             <thead>
                                                  <tr>
                                                       <th>Id Consultation</th>
                                                       <th>Date de laConsultation</th>
                                                       <th>Compte Rendu</th>
                                                       <th>id du patient</th>
                                                       <th>id du medecin</th>
                                                  </tr>
                                             ...
                                             <tbody>
                                                  <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                                       <tr>
                                                            <td><?php echo $row['Id_Consultation']; ?></td>
                                                            <td><?php echo $row['Date_Consultation']; ?></td>
                                                            <td><?php echo $row['Compte_Rendu_Consultation']; ?></td>
