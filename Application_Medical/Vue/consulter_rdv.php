...
require('../Controller/consulter_rdv_2bdd.php');
               ...
               <div id="content" class="span9">
                    <div class="main_body">
                         ...
                         <div class="Left-body">
                              ...
                              <div class="en_bref">
                                   <form action="../Controller/consulter_rdv_2bdd.php" method="get">
                                        <table>
                                             <thead>
                                                  <tr>
                                                       <th>Id RDV</th>
                                             ...
                                             <tbody>
                                                  <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                                       <tr>
                                                            ...
                                                            <td><?php echo $row['Date_Rendez_Vous']; ?></td>
                                                            <td><?php echo $row['Salle_Rendez_Vous']; ?></td>
