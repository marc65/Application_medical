...
class Util {
    ...
    public function getListePatients() {
        $Util = new Util();
        $Util->dbConnection();
        $Query = "SELECT Id_patient , Nom_Patient FROM patient";
    ...
    public function getListeMedecins() {
        $Util = new Util();
        $Util->dbConnection();
        $Query = "SELECT Id_Medecin , Nom_Medecin FROM medecin";
        $result = mysqli_query($Util->mysqli, $Query);
